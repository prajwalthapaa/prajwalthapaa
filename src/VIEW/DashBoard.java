...
public class DashBoard extends javax.swing.JFrame
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 480, 240, 70));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 240, 70));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 240, 60));
        ...
        getContentPane().add(btndeposit1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 240, 70));
        ...
        getContentPane().add(btnwithdraw1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 240, 60));
        ...
        getContentPane().add(btnlogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 10, 140, -1));
        ...
        getContentPane().add(btncrtacc1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 250, 70));
        ...
        getContentPane().add(btncrtacc, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 140, 110, 100));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 140, 110, 100));

        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIEW/withdraw.jpg"))); // NOI18N
        jButton6.setBorder(null);
        jButton6.setBorderPainted(false);
        jButton6.setContentAreaFilled(false);
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 140, 110, 100));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 280, 110, 100));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 280, 110, 100));

        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIEW/transfercash.jpg"))); // NOI18N
        jButton10.setBorder(null);
        jButton10.setBorderPainted(false);
        jButton10.setContentAreaFilled(false);
        getContentPane().add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 280, 110, 100));

        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIEW/calculator.jpg"))); // NOI18N
        jButton11.setBorder(null);
        jButton11.setBorderPainted(false);
        jButton11.setContentAreaFilled(false);
        getContentPane().add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 420, 110, 100));

        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIEW/currencyexchange.jpg"))); // NOI18N
        jButton12.setBorder(null);
        jButton12.setBorderPainted(false);
        jButton12.setContentAreaFilled(false);
        getContentPane().add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 420, 110, 100));
        ...
        getContentPane().add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 420, 110, 100));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIEW/DASHBOARD1.png"))); // NOI18N
...
this.setVisible(true);
 ...
 CA.setVisible(true);    }//GEN-LAST:event_btncrtaccActionPerformed
